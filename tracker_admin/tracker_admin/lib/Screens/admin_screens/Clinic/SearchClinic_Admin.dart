...
class SearchClinic_Admin extends StatefulWidget {
  SearchClinic_Admin({Key key}) : super(key: key);

  @override
  _SearchClinic_AdminState createState() => _SearchClinic_AdminState();
}

class _SearchClinic_AdminState extends State<SearchClinic_Admin> {
  double opac;
