...
class SearchPharmacy_Admin extends StatefulWidget {
  SearchPharmacy_Admin({Key key}) : super(key: key);

  @override
  _SearchPharmacy_AdminState createState() => _SearchPharmacy_AdminState();
}

class _SearchPharmacy_AdminState extends State<SearchPharmacy_Admin> {
  double opac;
  ...
  Future queryData(String queryString) async {
    setState(() {
      snap = FirebaseFirestore.instance.collection('Pharmacy').snapshots();
    });
  }
