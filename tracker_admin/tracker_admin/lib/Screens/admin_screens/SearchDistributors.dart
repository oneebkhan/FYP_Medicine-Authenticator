...
class SearchDistributors extends StatefulWidget {
  SearchDistributors({Key key}) : super(key: key);

  @override
  _SearchDistributorsState createState() => _SearchDistributorsState();
}

class _SearchDistributorsState extends State<SearchDistributors> {
  double opac;
  ...
  Future queryData(String queryString) async {
    setState(() {
      snap = FirebaseFirestore.instance.collection('Distributor').snapshots();
    });
  }
