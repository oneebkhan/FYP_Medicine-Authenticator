...
class SearchPharmacies extends StatefulWidget {
  SearchPharmacies({Key key}) : super(key: key);

  @override
  _SearchPharmaciesState createState() => _SearchPharmaciesState();
}

class _SearchPharmaciesState extends State<SearchPharmacies> {
  double opac;
