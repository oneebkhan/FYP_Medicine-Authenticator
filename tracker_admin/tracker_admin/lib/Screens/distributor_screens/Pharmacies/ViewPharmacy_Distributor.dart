...
class ViewPharmacy_Distributor extends StatefulWidget {
  // The name of the category opened
  final String pageName;
  final List pharmacies;

  const ViewPharmacy_Distributor({
    Key key,
  ...
  @override
  _ViewPharmacy_DistributorState createState() =>
      _ViewPharmacy_DistributorState();
}

class _ViewPharmacy_DistributorState extends State<ViewPharmacy_Distributor> {
  double opac;
  double height;
  double width;
  var pharmacyStream;
