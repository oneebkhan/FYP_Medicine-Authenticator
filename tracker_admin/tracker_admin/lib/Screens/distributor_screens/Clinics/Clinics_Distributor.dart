...
class Clinics_Distributors extends StatefulWidget {
  @override
  _Clinics_DistributorsState createState() => _Clinics_DistributorsState();
}

class _Clinics_DistributorsState extends State<Clinics_Distributors> {
  double width;
  double height;
  double opac;
  double opac2;
