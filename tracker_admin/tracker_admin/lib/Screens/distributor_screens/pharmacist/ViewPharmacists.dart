...
class ViewPharmacists extends StatefulWidget {
  ...
  @override
  _ViewPharmacistsState createState() => _ViewPharmacistsState();
}

class _ViewPharmacistsState extends State<ViewPharmacists> {
  double opac;
  var m;
  double height;
  double width;
