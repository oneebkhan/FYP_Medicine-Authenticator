...
class SearchPharmacist extends StatefulWidget {
  ...
  @override
  _SearchPharmacistState createState() => _SearchPharmacistState();
}

class _SearchPharmacistState extends State<SearchPharmacist> {
  double opac;
  ...
  Future queryData(String queryString) async {
    setState(() {
      snap = FirebaseFirestore.instance.collection('Pharmacist').snapshots();
    });
  }
