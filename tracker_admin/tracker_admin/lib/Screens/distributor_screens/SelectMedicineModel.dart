...
class SelectMedicineModel extends StatefulWidget {
  SelectMedicineModel({Key key}) : super(key: key);

  @override
  _SelectMedicineModelState createState() => _SelectMedicineModelState();
}

class _SelectMedicineModelState extends State<SelectMedicineModel> {
  double opac;
