...
class AddMedicine_Pharmacist extends StatefulWidget {
  AddMedicine_Pharmacist({Key key}) : super(key: key);

  @override
  _AddMedicine_PharmacistState createState() => _AddMedicine_PharmacistState();
}

class _AddMedicine_PharmacistState extends State<AddMedicine_Pharmacist> {
  double opac;
  ...
  addMedicineToPharmacy({medList, medName}) async {
    FirebaseFirestore.instance
        .collection('Pharmacy')
        .doc(pharmacistInfo['pharmacyID'])
        .update({
