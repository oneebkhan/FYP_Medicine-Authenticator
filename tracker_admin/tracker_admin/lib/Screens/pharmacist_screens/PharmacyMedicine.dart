...
import 'package:tracker_admin/screens/pharmacist_screens/MedicineInfo_Pharmacist.dart';

class PharmacyMedicine extends StatefulWidget {
  ...
  @override
  _PharmacyMedicineState createState() => _PharmacyMedicineState();
}

class _PharmacyMedicineState extends State<PharmacyMedicine> {
  double opac;
  var m;
  double height;
  double width;
